...
import { formatCurrency, getAssetUrl, humanizeCatalogValue } from "@/lib/utils";
          ...
          <div className="lg:pt-4">
            ...
            <div className="mt-8 border-y border-ink/10 py-6">
              <div className="flex items-end justify-between gap-4">
                <div>
                  {variant ? <p className="text-3xl font-bold text-ink">{formatCurrency(variant.price, variant.currency)}</p> : <p className="text-lg font-semibold text-ink/50">Select options to see price</p>}
