...
export default function UnitsPage() {
  ...
  return <>
    <PageIntro eyebrow="Inventory operations" title="Inventory units" description="Every row is one physical item. Search by SKU, serial number, IMEI, barcode, location, or status; SKU is optional." />
