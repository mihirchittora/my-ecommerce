...
const navGroups = [
  { label: "Workspace", items: [{ href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, permissions: ["CATALOG_READ", "INVENTORY_READ", "ORDER_READ", "CART_READ", "PAYMENT_READ", "SHIPPING_READ"] as Permission[] }] },
  userManagementGroup,
  ...
  { label: "Shipping", items: [{ href: "/shipments", label: "Shipments", icon: Truck, permissions: ["SHIPPING_READ"] as Permission[] }, { href: "/fulfillments", label: "Fulfillments", icon: Package, permissions: ["SHIPPING_READ"] as Permission[] }] },
];
