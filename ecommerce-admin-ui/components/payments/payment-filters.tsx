...
import { PAYMENT_METHODS, PAYMENT_PROVIDERS, PAYMENT_STATUSES, type PaymentListParams, type PaymentMethod, type PaymentProvider, type PaymentStatus } from "@/lib/api/payment/types";
import { titleCase } from "@/lib/utils";

type FilterValues = Pick<PaymentListParams, "status" | "provider" | "paymentMethod" | "currency" | "createdFrom" | "createdTo">;
...
export function isPaymentFilterMethod(value: string): value is PaymentMethod {
